...
I **dense non raggiungono la velocità di un MoE** (calcolano tutta la rete per token): fuori dal ruolo di modello unico veloce. La produzione Gemma 26B-A4B è MoE veloce ma **senza MTP** (bloccato sull'arch Gemma); il Qwen 35B-A3B **con MTP** è probabilmente **più veloce di Gemma**.
