...
**Implementazione:** non iniziata; nessuna progettazione, nessun ADR
**Conservazione:** roadmap persistente fino a implementazione dimostrata o
cancellazione esplicita di Roberto
**Decisione di prodotto:** un carico lungo interrotto deve poter riprendere
senza perdere il lavoro svolto e senza ripetere un effetto gia' prodotto;
l'utente formula il risultato voluto, non il flusso
**Documenti di origine:** questo mandato (§ Mandato in calce, integrale),
`internal/design/TODO.md::JOB-001`
**Confine verificato il 17/8/2026:** ADR 0196 (politica centrale di esecuzione
executor) e ADR 0204-0205 (ricorsione parallela deterministica) governano il
parallelismo **dentro** una invocazione, che vive quanto il turno. Qui serve
durevolezza **attraverso** i riavvii: nessuno dei due la copre. Il mandato non
e' quindi un duplicato di lavoro gia' fatto.

## 0. Nota di provenienza

Il testo che segue e' il mandato originale, riportato integralmente e senza
riscritture. Era rimasto in `runtime/static/`, la cartella degli asset web
serviti in forma anonima: fino al 17/8/2026 era scaricabile da chiunque
raggiungesse la porta 8770. La falla e' stata chiusa alla causa (la cartella
serve solo tipi-asset, il resto risponde 404) e il documento e' stato portato
qui, dove vivono i lavori grossi.

Il mandato **non e' ancora una roadmap nella forma richiesta dal README**
(obiettivo e valore, stato del codice verificato, proposta, invarianti e
non-obiettivi, rischi, fasi con criteri misurabili). Va riscritto in quella
forma come primo passo, insieme all'analisi di cosa i meccanismi esistenti
gia' forniscono davvero — scheduler v2, `executor_scheduler`, spool dei
risultati remoti, journal di undo.
