...
| [RM-0008](RM-0008-porta-unica-nascita-executor.md) | Porta unica di nascita e ciclo controllato degli executor sintetizzati | `active` | sviluppo autorizzato; F0 in corso, prima tranche fail-closed pubblicata; guardia Birth e quarantena orfani ancora aperte | 2026-08-25 |
