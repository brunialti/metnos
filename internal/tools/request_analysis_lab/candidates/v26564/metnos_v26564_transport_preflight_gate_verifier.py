#!/usr/bin/env python3
"""Offline verifier for the single V26.5.6.4 transport preflight gate.
...
VERSION = "metnos.v26.5.6.4-transport-preflight-gate-verifier/1.0"
REPOSITORY = Path("/opt/metnos")
HERE = REPOSITORY / "internal/tools/request_analysis_lab/candidates/v26564"
RUNNER_PATH = HERE / "metnos_v26564_k1_runner.py"
FREEZE_PATH = HERE / "metnos_v26564_author.freeze.json"
AUTHOR_PRE_GATE_PATH = HERE / "metnos_v26564_author_pre_gate.json"
STATIC_REVIEW_MD_PATH = HERE / "metnos_v26564_independent_static_review.md"
STATIC_REVIEW_JSON_PATH = HERE / "metnos_v26564_independent_static_review.json"
...
AUTHORIZATION_PATH = HERE / "metnos_v26564_transport_preflight_authorization_review.json"
VERIFICATION_PATH = HERE / "metnos_v26564_transport_preflight_gate_verification.json"
GATE_PATH = HERE / "metnos_v26564_preflight_gate.lock.json"
EXTERNAL_GATE_PATH = HERE / "metnos_v26564_external_gate.lock.json"
VERIFIER_PATH = Path(__file__).resolve(strict=True)
OUTPUT_PATH = Path("/tmp/metnos_v26564_transport_preflight.json")
...
EXPECTED_HASHES = {
    ...
    "author_pre_gate": "365bc9637fb3c1d1d09812968b5ad85de0875b0b09fc3f21834c89fbca178236",
    "static_review_md": "e4323dc28552768fcbbc88e952145f1abdd188b2172d02efb81c0171b1efdd06",
    "static_review_json": "394d851559ee8b13e50c25a45681d37c2f04c04eabbf36d12bcd892aaf4f0636",
    ...
    "artifact_pins_canonical": "f57f7e9f30c5da4921d5854be3563dbad3de09fcc1d992dd0368afc95bdb54ec",
}
...
def expected_authorization() -> dict[str, Any]:
    return {
        "version": "metnos.v26.5.6.4-transport-preflight-authorization-review/1.0",
...
def _gate_mutations() -> list[tuple[str, Callable[[dict[str, Any]], None]]]:
    ...
    mutations = [
        ("version", set_value(("version",), "metnos.v26.5.6.4-preflight-gate/2.0")),
...
def expected_verification(authorization_sha256: str) -> dict[str, Any]:
    ...
    return {
        "version": "metnos.v26.5.6.4-transport-preflight-gate-verification/1.0",
        "status": "PASS",
...
def expected_gate(authorization_sha256: str, verification_sha256: str) -> dict[str, Any]:
    return {
        "version": "metnos.v26.5.6.4-preflight-gate/1.0",
        "status": "authorized_transport_preflight_only",
        "authority": "independent_v26564_preflight_gate_verifier",
...
def _verify_dependencies(freeze: dict[str, Any]) -> None:
    ...
    if (
        ...
        or review.get("verdict") != "STATIC_PASS"
        or review.get("live_authorization") is not False
        or review.get("preflight_authorization") is not False
    ):
        raise RuntimeError("static review is not the pinned offline PASS")
    pins = freeze.get("artifact_pins")
    if type(pins) is not dict or len(pins) != 20:
...
def _load_runner() -> Any:
    spec = importlib.util.spec_from_file_location(
        "metnos_v26564_independent_preflight_runner", RUNNER_PATH,
    )
    if spec is None or spec.loader is None:
        raise RuntimeError("cannot load frozen V26.5.6.4 runner")
