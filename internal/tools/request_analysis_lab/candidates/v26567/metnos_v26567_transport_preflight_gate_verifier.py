#!/usr/bin/env python3
"""Offline verifier for the single V26.5.6.7 transport preflight gate.
...
VERSION = "metnos.v26.5.6.7-transport-preflight-gate-verifier/1.0"
REPOSITORY = Path("/opt/metnos")
HERE = REPOSITORY / "internal/tools/request_analysis_lab/candidates/v26567"
RUNNER_PATH = HERE / "metnos_v26567_k1_runner.py"
FREEZE_PATH = HERE / "metnos_v26567_author.freeze.json"
AUTHOR_PRE_GATE_PATH = HERE / "metnos_v26567_author_pre_gate.json"
...
STATIC_REVIEW_MD_PATH = HERE / "metnos_v26567_author_static_review.md"
STATIC_REVIEW_JSON_PATH = HERE / "metnos_v26567_author_static_review.json"
...
AUTHORIZATION_PATH = HERE / "metnos_v26567_transport_preflight_authorization_review.json"
VERIFICATION_PATH = HERE / "metnos_v26567_transport_preflight_gate_verification.json"
GATE_PATH = HERE / "metnos_v26567_preflight_gate.lock.json"
EXTERNAL_GATE_PATH = HERE / "metnos_v26567_external_gate.lock.json"
VERIFIER_PATH = Path(__file__).resolve(strict=True)
OUTPUT_PATH = Path("/tmp/metnos_v26567_transport_preflight.json")
...
EXPECTED_HASHES = {
    ...
    "author_pre_gate": "de5b931c02d4842982bdf01a14fb04343884adbab4d77b4801a03e490ada3e5c",
    "static_review_md": "9f42a1ac850417a85ead23a5f071dcb69029763b873a9602f894654d809c570b",
    "static_review_json": "c81b781862637c7e4578a17eb1cb0936b359c4e0b0f96db7a0443165748a839d",
    ...
    "artifact_pins_canonical": "f91f7299f46720a1400e428b6e9c78c9448a32829708a222d85a7ca3efad64e5",
}
...
def expected_authorization() -> dict[str, Any]:
    return {
        "version": "metnos.v26.5.6.7-transport-preflight-authorization-review/1.0",
...
def _gate_mutations() -> list[tuple[str, Callable[[dict[str, Any]], None]]]:
    ...
    mutations = [
        ("version", set_value(("version",), "metnos.v26.5.6.7-preflight-gate/2.0")),
...
def expected_verification(authorization_sha256: str) -> dict[str, Any]:
    ...
    return {
        "version": "metnos.v26.5.6.7-transport-preflight-gate-verification/1.0",
        "status": "PASS",
...
def _load_runner() -> Any:
    spec = importlib.util.spec_from_file_location(
        "metnos_v26567_independent_preflight_runner", RUNNER_PATH,
    )
    if spec is None or spec.loader is None:
        raise RuntimeError("cannot load frozen V26.5.6.7 runner")
