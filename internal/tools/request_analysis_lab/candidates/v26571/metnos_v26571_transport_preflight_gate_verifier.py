#!/usr/bin/env python3
"""Offline verifier for the single V26.5.7.1 transport preflight gate.
...
VERSION = "metnos.v26.5.7.1-transport-preflight-gate-verifier/1.0"
REPOSITORY = Path("/opt/metnos")
HERE = REPOSITORY / "internal/tools/request_analysis_lab/candidates/v26571"
RUNNER_PATH = HERE / "metnos_v26571_k1_runner.py"
FREEZE_PATH = HERE / "metnos_v26571_author.freeze.json"
AUTHOR_PRE_GATE_PATH = HERE / "metnos_v26571_author_pre_gate.json"
...
STATIC_REVIEW_MD_PATH = HERE / "metnos_v26571_author_static_review.md"
STATIC_REVIEW_JSON_PATH = HERE / "metnos_v26571_author_static_review.json"
...
AUTHORIZATION_PATH = HERE / "metnos_v26571_transport_preflight_authorization_review.json"
VERIFICATION_PATH = HERE / "metnos_v26571_transport_preflight_gate_verification.json"
GATE_PATH = HERE / "metnos_v26571_preflight_gate.lock.json"
EXTERNAL_GATE_PATH = HERE / "metnos_v26571_external_gate.lock.json"
VERIFIER_PATH = Path(__file__).resolve(strict=True)
OUTPUT_PATH = Path("/tmp/metnos_v26571_transport_preflight.json")
...
EXPECTED_HASHES = {
    ...
    "author_pre_gate": "b94906ffbe93ca700ce3f5eaa7adf325852afcbea8f1fce4110249786a6b7542",
    "static_review_md": "ec68ea7e9bea1ef1dbc108afd18a5be5c092fd4987891011f43697eb3c1dbbdd",
    "static_review_json": "202cc632a7b33999a0bd628aa32ff669a96bcbb7f50d5c019a21a5f084cf6d9b",
    ...
    "artifact_pins_canonical": "911e35b0e10e459418edb7b8272bb750fe56346f945bb6b8a81c174609aca791",
}
...
def expected_authorization() -> dict[str, Any]:
    return {
        "version": "metnos.v26.5.7.1-transport-preflight-authorization-review/1.0",
...
def _gate_mutations() -> list[tuple[str, Callable[[dict[str, Any]], None]]]:
    ...
    mutations = [
        ("version", set_value(("version",), "metnos.v26.5.7.1-preflight-gate/2.0")),
...
def expected_verification(authorization_sha256: str) -> dict[str, Any]:
    ...
    return {
        "version": "metnos.v26.5.7.1-transport-preflight-gate-verification/1.0",
        "status": "PASS",
...
def _load_runner() -> Any:
    spec = importlib.util.spec_from_file_location(
        "metnos_v26571_independent_preflight_runner", RUNNER_PATH,
    )
    if spec is None or spec.loader is None:
        raise RuntimeError("cannot load frozen V26.5.7.1 runner")
