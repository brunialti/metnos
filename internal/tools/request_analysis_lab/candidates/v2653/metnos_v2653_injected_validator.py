#!/usr/bin/env python3
"""Registry-injected technical schema and validator for V26.5.3.
...
VERSION = "metnos.v26.5.3-injected-validator/0.1"
...
try:
    _REGISTRY_BYTES = __metnos_registry_bytes__
except NameError as error:
    raise RuntimeError("verified registry bytes were not injected") from error
if type(_REGISTRY_BYTES) is not bytes:
    raise RuntimeError("injected registry must be exact bytes")
del __metnos_registry_bytes__
