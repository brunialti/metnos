"""RUN 2 arm B: one strict structured response, byte-preserving, no repair."""
...
from internal.tools.request_analysis_lab.prototypes.intent_shadow_v0_1.candidate_v0_3.structured_client import build_request as build_structured_request
...
def extract_response(raw_content: bytes) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "adapter_version": "candidate-v0.3/run2", "status": "technical_invalid",
    ...
    if not compilation.valid:
        return {
            "adapter_version": "candidate-v0.3/run2", "status": "document_invalid",
            "raw_model_output_b64": raw_b64, "raw_model_output_sha256": raw_sha,
