"""Positive and structural tests for blueprint engine v0.3."""
...
class EngineTests(unittest.TestCase):
    ...
    def test_09_full_case_artifact_validation(self):
        ...
        inputs = {
            "author": bundle,
            "pool_a": e.canonical_bytes(e.pool_a_bundle_value(proposal, self.registry, self.glossary, rubrics)),
            "pool_b": e.canonical_bytes(e.pool_b_bundle_value(proposal, query, self.registry, self.glossary, rubrics)),
        ...
        e.validate_case_artifacts(envelope, proposal_bytes=proposal_bytes, projection_bytes=projection,
            ...
            glossary=self.glossary, matrix=matrix, rubrics=rubrics, process_freeze_bytes=freeze_bytes)
