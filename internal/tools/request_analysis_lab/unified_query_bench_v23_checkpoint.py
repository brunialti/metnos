...
def schema(prompt_variant: str = "v20") -> dict:
    ...
    elif prompt_variant in ("v23", "v23lite"):
...
def folded_call(query: str, *, prompt_variant: str = "v0",
    ...
    if prompt_variant in ("v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += """\
...
"""
    if prompt_variant in ("v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + ONTOLOGY_REFINEMENTS
    if prompt_variant in ("v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + TIE_BREAK_REFINEMENTS
    if prompt_variant in ("v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + STRUCTURE_REFINEMENTS
    if prompt_variant in ("v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + COMPOUND_REFINEMENTS
    if prompt_variant in ("v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + STRICT_COMPOUND_REFINEMENTS
    if prompt_variant in ("v9", "v10", "v11", "v12", "v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + ANCHOR_AND_SINK_REFINEMENTS
    if prompt_variant in ("v10", "v11", "v12"):
        instruction += "\n" + VERB_LAYER_REFINEMENTS
    if prompt_variant == "v12":
        instruction += "\n" + PRECOMPUTED_HEAD_REFINEMENTS
    if prompt_variant in ("v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + LEMMA_LAYER_REFINEMENTS
    if prompt_variant in ("v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23"):
        instruction += "\n" + EFFECT_LAYER_REFINEMENTS
    if prompt_variant in ("v15", "v17", "v19", "v20", "v21", "v22", "v23"):
        instruction += "\n" + MORPH_SEMANTIC_REFINEMENTS
    if prompt_variant in ("v17", "v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + GLOSS_REFINEMENTS
    if prompt_variant in ("v19", "v20", "v21", "v22", "v23", "v23lite"):
        instruction += "\n" + SCOPE_REFINEMENTS
    ...
    body = {
        ...
        "temperature": 0,
        "seed": 42,
        "max_tokens": 2600 if prompt_variant in ("v22", "v23", "v23lite") else (
...
def validate_frame_v23(frame: dict, tokens: list[str],
    ...
    for index, (head, item) in enumerate(zip(heads, predicates), 1):
        ...
        if (not isinstance(gloss, str) or not gloss.strip()
                ...
                or not re.fullmatch(r"[A-Za-z][A-Za-z -]*", gloss.strip())):
            return False, f"semantic_{index}_gloss"
        effect_valid = ("effect" not in head if prompt_variant == "v23lite"
...
def main() -> int:
    ...
    ap.add_argument("--dataset", choices=("mono", "compound", "all"),
                    default="mono")
    ap.add_argument("--variant", choices=("v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v17", "v19", "v20", "v21", "v22", "v23", "v23lite"),
                    default="v0")
