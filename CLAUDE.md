...
ADR registry canonico: `/opt/myclaw/decisions/` (`0001-0137`, `0055`/`0115`/`0116`/`0121` skipped — fonte unica per "perche' abbiamo scelto cosi'").
