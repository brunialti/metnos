...
ADR registry canonico: `decisions/` (relative alla repo root; `0001-0186`, `0055`/`0115`/`0116`/`0121` skipped — fonte unica per "perche' abbiamo scelto cosi'").
...
- ADR registry: `decisions/` (`0001-0186`, `0055`/`0115`/`0116`/`0121` skipped) — dettagli implementativi e razionale.
