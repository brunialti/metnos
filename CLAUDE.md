...
- **Skill importer agentskills.io → executor** (ADR 0123): pipeline 5-stadi. CLI `metnos-skills`. Mapping `runtime/skill_vocab_map.json`. Smoke `runtime/smoke_imports.py`.
