...
- **Polarita' sintattica condivisa** (ADR 0215): `detection_lexicon.asserted_at` usa i concetti traducibili `syntax.negation` e `syntax.contrast`; i recognizer di dominio non mantengono liste proprie. Gate: `test_detection_lexicon.py` e `test_target_device.py` sui contrasti IT/EN.
