...
|---|---|---|
| **1 — Bootstrap** | crea venv `~/.local/share/metnos/.venv/` Python 3.12+, installa `metnos` wheel + deps. Verifica disco: 8 GB minimi (5 GB modelli + 2 GB index foto stimati + 1 GB resto). Verifica python>=3.12, libstdc++ >= 11. | sentinella `~/.local/state/metnos/install/phase1.done` |
