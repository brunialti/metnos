...
Input: /opt/metnos/e2e/simulator/test_set_FROZEN.json
Output: /opt/metnos/e2e/simulator/test_set_FROZEN_v2.json
...
TEST_SET = Path("/opt/metnos/e2e/simulator/test_set_FROZEN.json")
OUTPUT = Path("/opt/metnos/e2e/simulator/test_set_FROZEN_v2.json")
