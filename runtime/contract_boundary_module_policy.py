...
BOUNDARY_MODULE_OWNERS_V1 = (
    ...
    BoundaryModuleOwnerV1('executor_lifecycle_state', ('executor_lifecycle_state', 'runtime.executor_lifecycle_state')),
    ...
    BoundaryModuleOwnerV1('birth_certification_authority_provisioner', ('install.birth_certification_authority_provisioner',)),
    BoundaryModuleOwnerV1('birth_lifecycle_migration', ('install.birth_lifecycle_migration',)),
    BoundaryModuleOwnerV1('f5_authority', ('install.f5_authority',)),
    BoundaryModuleOwnerV1('birth_certification_issuer', ('install.birth_certification_issuer',)),
    BoundaryModuleOwnerV1('birth_certification_evidence', ('install.birth_certification_evidence',)),
...
BOUNDARY_SOURCE_OWNERS_V1 = (
    ...
    BoundarySourceOwnerV1('runtime/executor_lifecycle_state.py', 'executor_lifecycle_state'),
    ...
    BoundarySourceOwnerV1('install/birth_certification_authority_provisioner.py', 'birth_certification_authority_provisioner'),
    BoundarySourceOwnerV1('install/birth_lifecycle_migration.py', 'birth_lifecycle_migration'),
    BoundarySourceOwnerV1('install/f5_authority.py', 'f5_authority'),
    BoundarySourceOwnerV1('install/birth_certification_issuer.py', 'birth_certification_issuer'),
    BoundarySourceOwnerV1('install/birth_certification_evidence.py', 'birth_certification_evidence'),
