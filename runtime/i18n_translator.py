...
# Mapping fisso prescrittivo IT→EN per le sezioni stilistiche §6 di CLAUDE.md.
...
PRESCRIPTIVE_MAP_IT_EN: dict[str, str] = {
    # Marker di anti-pattern (CLAUDE.md §6): plurali e maiuscolo preservato.
