...
QUERIES: list[dict] = [
    ...
    {"id": "complex_propose_morning",
     ...
     "complexity": "complex"},
    {"id": "complex_propose_silvia",
     "query": "proponi 3 orari per un appuntamento con Silvia di una ora la mattina settimana prossima, dopo la scelta mandami una email con la scelta",
     "expected_first_tool": "find_events_empty",
     "complexity": "complex"},
