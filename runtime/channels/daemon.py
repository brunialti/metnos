...
class ChannelDaemon:
    ...
    def _handle_message_scoped(self, msg: InboundMessage) -> dict:
        ...
        if atts and self.channel.name == "telegram":
            ...
            # LAN-only (192.168.1.33:8770), accessibile via VPN/Tailscale.
            try:
                import os as _os
                host = _os.environ.get("METNOS_PUBLIC_HOST", "192.168.1.33")
        ...
        # Lo step 3 e' la garanzia anti-silent-failure (CLAUDE.md 2.8): l'utente
