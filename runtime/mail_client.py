...
~/.config/account_personal/mail.env (legacy example.com). Variabili attese:
  ...
  account_personal: MYKLEOS_MAIL_HOST, MYKLEOS_MAIL_PORT, MYKLEOS_MAIL_USER,
           MYKLEOS_MAIL_PASS.
...
def _account_creds(account: str) -> dict:
    ...
    if account == "account_personal":
        ...
        return {
            "imap_host": env.get("MYKLEOS_MAIL_HOST", "imap.example.com"),
            "imap_port": int(env.get("MYKLEOS_MAIL_PORT", "993")),
            "smtp_host": env.get("MYKLEOS_SMTP_HOST", "smtp.example.com"),
