...
BIRTH_AUTHORITY_POLICY_V1 = BirthAuthorityPolicyV1(
    ...
    coordinator_store_owners=(
        ...
        'install/birth_certification_evidence.py:_evidence_at_v1',
        'install/birth_certification_evidence.py:_open_database',
        'install/birth_certification_evidence.py:administrative_evidence_v1',
