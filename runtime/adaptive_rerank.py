...
2. **Consumer field match** (Layer 3, 5/5/2026): identifica gli executor
   ...
   convenzione di naming Metnos già stringente (CLAUDE.md §2.10
...
# naming Metnos già stringente (CLAUDE.md §2.10): se step1 produce
...
def _produced_keys(observation: dict | None) -> set[str]:
    ...
    Convenzione Metnos (CLAUDE.md §2.6):
