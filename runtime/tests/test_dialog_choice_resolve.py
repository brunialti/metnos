...
def _choice_state(dialog_id="dc01"):
    return {
        ...
        "actor": "host", "channel": "http", "timeout_s": 3600,
...
def test_consume_resolves_index_to_value(dp):
    ...
    res = dp.consume_pending_step("http:host", "dc01", "object", "1")
