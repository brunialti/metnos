"""Anti-regressione (§10.6): la suite executor-manifest (`run_all_tests.py`)
NON deve piu' restare ORFANA dal loop di test.

Storia (7/7/2026): 12 regressioni silenziose si erano accumulate perche'
`run_all_tests.py` era referenziato SOLO in `export-public.sh` — mai nel gate
