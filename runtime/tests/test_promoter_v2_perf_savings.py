...
class TestPerfMarkdown(_BasePerfTest):
    ...
    def test_format_with_data(self):
        ...
        self.assertIn("p50 OGGI 5000ms", out)
        self.assertIn("Token in: ~8000/turno (-80.8%)", out)
        self.assertIn("N=3 turni analizzati", out)
        self.assertIn("Frequenza: 42 chiamate/60g", out)
    ...
    def test_format_with_fallbacks(self):
        ...
        out = promoter_example._format_perf_savings_block(savings, lang="it")
        self.assertIn("## Stima risparmio", out)
        self.assertIn("Tempo: n/a (dati insufficienti)", out)
        self.assertIn("Token in: n/a (dati insufficienti)", out)
