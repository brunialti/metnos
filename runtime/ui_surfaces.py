...
SURFACES: tuple[UiSurfaceSpec, ...] = (
    ...
    UiSurfaceSpec(
        ...
        "Configurazione effettiva e modificabile dei modelli linguistici, degli embedder e dei modelli visivo-linguistici.",
        "Effective, editable configuration for language, embedding, and vision models.",
        (
            "famiglie LLM, embedding e VLM",
            "tier fast, middle, wise e frontier e ruoli text, image e default",
            "fornitore, modello, endpoint o URL di base effettivi",
            "parametri di generazione LLM, fra cui think, temperature e reasoning_budget",
        ...
        (
            ...
            "fast, middle, wise, and frontier tiers and text, image, and default roles",
            "effective provider, model, endpoint, or base URL",
            "LLM generation parameters, including think, temperature, and reasoning_budget",
        ...
        (
            ...
            "modifica una famiglia e salva i valori visibili",
            "annulla le modifiche non salvate",
            "ripristina i valori iniziali della versione installata",
        ),
        (
            "reload the configuration from its file",
            "edit one family and save visible values",
            "cancel unsaved changes",
            "restore the installed version's initial values",
        ),
        (
            "Nella chat web apri Settings > Sistema > Modelli.",
            "Scegli la famiglia e controlla sia il valore sia la sua provenienza: file, valore iniziale, alias o valore di riserva dopo un errore.",
            "Premi Modifica, cambia soltanto i campi necessari e scegli Salva modifiche; Metnos valida l'intero file prima di sostituirlo e conserva una copia privata di recupero.",
            ...
            "Per tornare alla configurazione fornita dalla versione installata scegli Ripristina e conferma: anche in questo caso la configurazione precedente viene conservata come copia di recupero.",
        ),
        (
            "In the web chat, open Settings > System > Models.",
            "Choose the family and inspect both each value and its origin: file, default, alias, or fallback after an error.",
            "Press Edit, change only the necessary fields, and choose Save changes; Metnos validates the complete file before replacing it and retains a private recovery copy.",
            "Subsequent calls use the new configuration; Reload configuration shows what the runtime resolves from the file again.",
            "To return to the configuration supplied by the installed version, choose Restore defaults and confirm: the previous configuration is retained as a recovery copy in this case too.",
        ),
        (
