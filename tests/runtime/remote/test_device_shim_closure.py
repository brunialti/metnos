...
_SHIM_SOURCES = {
    ...
    "executor_workers.py": _RUNTIME / "executor_workers.py",
    "worker_policy.py": _RUNTIME / "worker_policy.py",
    "messages.py": _RUNTIME / "device_shim" / "messages.py",
    "path_alias.py": _RUNTIME / "path_alias.py",
    "parallel_walk.py": _RUNTIME / "parallel_walk.py",
    "tabular_projection.py": _RUNTIME / "tabular_projection.py",
