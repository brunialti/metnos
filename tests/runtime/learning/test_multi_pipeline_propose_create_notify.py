...
Run con `python3 -m pytest tests/runtime/learning/test_multi_pipeline_propose_create_notify.py -v`.
"""
...
_EXECUTORS = Path(__file__).resolve().parents[3] / "executors"
...
def test_get_proposals_affinity_no_bare_propose_terms():
    ...
    """
    import tomllib
    manifest_path = Path(__file__).resolve().parents[3] / "executors/get_proposals/manifest.toml"
