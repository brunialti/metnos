...
Run: `python3 -m pytest tests/runtime/http/test_http_multipart_uploads.py -xvs`.
"""
...
class _FakeRequest:
    ...
    def __init__(self, *, content_type: str, form_items=None,
        ...
        self._context = {}
    def get(self, key, default=None):
        """aiohttp Request espone anche una mapping per i dati middleware."""
