...
class TestDormancyGate(unittest.TestCase):
    ...
    def test_excluded_when_registry_empty(self):
        # Isola la precondizione dal registro process-global: altre suite
        # possono aver bootstrap-pato store reali prima di questo test.
        with mock.patch.object(_store, "registered", return_value=[]):
