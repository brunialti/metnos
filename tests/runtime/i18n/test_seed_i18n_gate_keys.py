...
_REQUIRED_PROMOTER_DIGEST_KEYS = (
    ...
    "MSG_PROMOTER_REVIEW_CONFIRM",
    "MSG_PROMOTER_REVIEW_ROLLBACK",
    "MSG_PROMOTER_REVIEW_SKIP",
    "MSG_PROMOTER_REVIEW_PROMOTE_NOW",
    "MSG_PROMOTER_REVIEW_ARCHIVE",
    "MSG_PROMOTER_REVIEW_CONFIRM_ARCHIVE",
    "MSG_PROMOTER_REVIEW_RESURRECT",
    ...
    "MSG_PROMOTER_REVIEW_TITLE",
    "MSG_PROMOTER_REVIEW_DESCRIPTION",
)
...
_REQUIRED_UI_VIRT_KEYS = (
    ...
    "UI_VIRT_BINDING",
    "UI_VIRT_OBSERVED_MODEL",
    "UI_VIRT_MODEL_OBSERVED_AT",
    "UI_VIRT_MODEL_STATUS_OBSERVED",
    "UI_VIRT_MODEL_STATUS_AMBIGUOUS",
    "UI_VIRT_MODEL_STATUS_EMPTY",
    "UI_VIRT_MODEL_STATUS_UNREACHABLE",
    "UI_VIRT_MODEL_STATUS_UNSUPPORTED",
    "UI_VIRT_MODEL_STATUS_NOT_OBSERVED",
    "UI_VIRT_MODEL_STATUS_STALE",
