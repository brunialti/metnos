...
Carica query classificate dal DB estratto da `tests/e2e/corpus/extract.py` e
...
class Corpus:
    ...
    def positives(self, *, limit: int = 10,
        ...
        """Query read-only con feedback ok o successo operativo provato."""
        return self.sample(category=category, mutating=False,
                           success=1, limit=limit)
