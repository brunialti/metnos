...
```
python3 tests/benchmarks/repro_prefilter_bench.py --mode comparison   # recall/latency table
python3 tests/benchmarks/repro_prefilter_bench.py --mode scaling      # recall vs pool size (84→1000)
```
