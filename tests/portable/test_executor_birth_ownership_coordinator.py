...
_CONTEXT_TRANSITION_ID = "sha256:" + "8" * 64
...
def _distribution(tmp_path, name="current"):
    ...
    contents = {
        ...
        "install/executor_birth_append_journal_posix.py": ("runtime_code", b"VALUE = 1\n"),
        "install/executor_birth_contract_convergence.py": ("runtime_code", b"VALUE = 1\n"),
        ...
        "install/executor_birth_legacy_state_adoption.py": ("runtime_code", b"VALUE = 1\n"),
        "install/executor_birth_legacy_state_effect_posix.py": ("runtime_code", b"VALUE = 1\n"),
        "install/executor_birth_legacy_state_inspection.py": ("runtime_code", b"VALUE = 1\n"),
        "install/executor_birth_legacy_state_journal_posix.py": ("runtime_code", b"VALUE = 1\n"),
        "install/executor_birth_legacy_state_posix.py": ("runtime_code", b"VALUE = 1\n"),
        "install/executor_birth_posix_directory.py": ("runtime_code", b"VALUE = 1\n"),
        ...
        "runtime/executor_birth_authority_gate.py": ("runtime_code", b"VALUE = 1\n"),
        ...
        "runtime/executor_birth_host_chain_policy.py": ("runtime_code", b"VALUE = 1\n"),
        ...
        "runtime/executor_birth_legacy_state.py": ("runtime_code", b"VALUE = 1\n"),
        "runtime/executor_birth_legacy_state_journal.py": ("runtime_code", b"VALUE = 1\n"),
        "runtime/executor_birth_legacy_state_policy.py": ("runtime_code", b"VALUE = 1\n"),
        "runtime/executor_birth_legacy_state_preflight_projection.py": ("runtime_code", b"VALUE = 1\n"),
        "runtime/executor_birth_legacy_state_request.py": ("runtime_code", b"VALUE = 1\n"),
        "runtime/executor_birth_legacy_state_wire.py": ("runtime_code", b"VALUE = 1\n"),
...
def _crash_publish(journal_path, certificate_path, authority_path, point):
    ...
    _publish_certificate_with_prerequisite_v1(
        ...
        _crash_seam=crash,
        context_transition_id=_CONTEXT_TRANSITION_ID,
...
def test_partial_certificate_temporary_is_rebuilt_before_publication(tmp_path):
    ...
    _payload, signature = issue_ownership_cutover_certificate(
        ...
        context_transition_id=_CONTEXT_TRANSITION_ID,
        dominant_startup_receipt=_CROSSING_RECEIPT,
