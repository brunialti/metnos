...
def _preview(args: dict) -> dict:
    ...
    confirmation_required = apply_ready and bool(mutations)
    ...
    out = {
        ...
        "confirmation_token": plan["token"] if confirmation_required else None,
        "expires_at": plan["expires_at"] if confirmation_required else None,
