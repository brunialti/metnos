...
Contratto:
    args:
      ...
      account?: 'metnos_system'|'metnos_secondary'|'account_personal'|...
...
# --- dispatch table (the design guide §7.9 codice deterministico) -----------------
...
def invoke(args):
    ...
    # è esaurito (es. Migadu out-quota → METNOS_DEFAULT_MAIL_ACCOUNT=account_work),
