...
def invoke(args):
    ...
    # Un verbo solo per ogni provider: il dispatcher non sa chi sia il
    # fornitore, quindi non puo' avere un nome di metodo per fornitore
    # (RM-0011). Il backend gw esponeva `delete`, il locale `delete_files`.
